...
public class ConsumerApp {
    ...
    private void setupLog4j2() throws AppFatalException {
        ...
        String log4j2ConfigFile = String.format("%s/log4j2.xml", phase);
        String exceptionMessage = String.format("Cannot load log4j2 config file: %s", log4j2ConfigFile);
        try {
            ...
            LoggerContext context = LoggerContext.getContext(ConsumerApp.class.getClassLoader(), false, log4j2ConfigFileUrl.toURI());
        } catch (Exception e) {
